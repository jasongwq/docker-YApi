######## 构建 ########
FROM --platform=${BUILDPLATFORM:-amd64} lzzcn738.mirror.aliyuncs.com/library/node:12.16.3-alpine3.11 as builder
...
######## 镜像 ########
FROM lzzcn738.mirror.aliyuncs.com/library/node:12.16.3-alpine3.11
